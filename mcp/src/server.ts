...
function convertLbToKg(value: number): number {
  return Math.round(value * 0.453592 * 10) / 10; // Round to 1 decimal
}

function formatLoadWithConversion(value: number, unit: string): string {
  if (unit === 'lb') {
